...
[Serializable]
public struct StageObjectDefaultData
{
    public string type;
...
public abstract class StageObjectBase : MonoBehaviour
{
    ...
    protected StageObjectDefaultData PrepareBaseData(string typeName = null)
    {
        StageObjectDefaultData d = new StageObjectDefaultData();
    ...
    protected void SendSavedData<T>(T data)
    {
        ...
        save.Add(JsonUtility.ToJson(data));
    }

    protected void ApplyTransform(StageObjectDefaultData data)
    {
        transform.position = data.position;
        transform.localScale = data.scale;
        transform.eulerAngles = data.rotationEuler;
    }
}
